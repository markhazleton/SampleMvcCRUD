...
$currentContent = gh api repos/markhazleton/UISampleSpark/contents/.github/dependabot.yml | ConvertFrom-Json
...
if ($decodedContent -match "UISampleSpark.HttpClientFactory") {
    ...
    Write-Host ""
    Write-Host "Add the following configuration after the '/UISampleSpark.Data' section:" -ForegroundColor Cyan
    Write-Host @"
