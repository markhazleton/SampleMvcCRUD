...
namespace Mwh.Sample.Common.RestSharp.Clients
{
    ...
    ///
    /// </summary>
    public class EmployeeRestSharpClient : RestSharpClientBase, IEmployeeClient
    {
        public EmployeeRestSharpClient(IHttpContextAccessor httpContextAccessor) : base($"{httpContextAccessor.HttpContext.Request.Scheme}://{httpContextAccessor.HttpContext.Request.Host}{httpContextAccessor.HttpContext.Request.PathBase}", "employee")
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeRestSharpClient"/> class.
        /// </summary>
        /// <param name="apiPath">The API path.</param>
        /// <param name="appName">Name of the application.</param>
        public EmployeeRestSharpClient(string apiPath, string appName) : base(apiPath, appName)
        {
        }
