# SampleMvcCRUD Constitution (DRAFT)
...
- **Source**: Analyzed 94 C# source files in SampleMvcCRUD repository
...
**Evidence**: 
- All 6 projects have nullable enabled: `Mwh.Sample.Web.csproj`, `Mwh.Sample.Domain.csproj`, etc.
...
**Evidence**:
- MSTest configured: `Mwh.Sample.Domain.Tests.csproj`, `Mwh.Sample.Repository.Tests.csproj`
